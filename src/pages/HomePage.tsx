...
import { ArrowRight, Star, Truck, Shield, Clock, ChevronRight, ChevronLeft, Sparkles } from 'lucide-react';
        ...
        <Slider {...sliderSettings}>
          <div>
            <div className="relative h-[500px] md:h-[600px]">
              ...
              <img 
                src="https://images.unsplash.com/photo-1581078426770-6d336e5de7bf?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80" 
                alt="Custom t-shirts" 
                ...
                <div className="container mx-auto px-4">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-xl mb-8">
                      Elevate your style with our premium hoodies, t-shirts, and more. Perfect for teams, events, or personal expression.
                    </p>
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="container mx-auto px-4">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-xl mb-8">
                      Turn your favorite photos and artwork into stunning canvas prints, posters, and more. Perfect for home or office decoration.
                    </p>
                    <div className="flex flex-wrap gap-4">
                      <Link 
