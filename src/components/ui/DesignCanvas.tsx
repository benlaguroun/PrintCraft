...
const DesignCanvas: React.FC<DesignCanvasProps> = ({
  ...
  const getPrintAreaPosition = () => {
    switch (position) {
      case "front":
        return { top: "45%", left: "50%", width: "40%", height: "40%" };
      case "back":
        return { top: "40%", left: "50%", width: "40%", height: "40%" };
      case "left sleeve":
        return { top: "35%", left: "40%", width: "20%", height: "20%" };
      case "right sleeve":
        return { top: "35%", left: "60%", width: "20%", height: "20%" };
      default:
